...
describe "UserPages" do
	...
	describe "profile page" do
		...
		describe "pagination" do
			...
			before do
				30.times { FactoryGirl.create(:micropost, user: user, content: "Ipsum Yorel") }
		...
		it { should have_selector('div.pagination') }
			...
			it "should list each micropot" do
		...
		describe "Another user's micropost can't be deleted" do
